...
class TerminalOutput:
    ...
    def display(self, analysis_results, fusion_summary, selected_tables, nmap_commands):
        """Display selected tables in terminal"""
    ...
    def display_table2(self, table2_data):
        ...
        for ip, data in table2_data.items():
            ...
            print(f"│ OS: {Fore.YELLOW}{data['os'][:30]}{Style.RESET_ALL}")
    ...
    def display_table4(self, table4_data):
        ...
        for port_key, data in list(table4_data.items())[:10]:
            ...
            headers = [
                ...
                f"{Fore.CYAN}Business Function{Style.RESET_ALL}"
            ]
    ...
    def _display_summary(self, analysis_results):
        ...
        print(f"{Fore.CYAN}{Style.BRIGHT}╔════════════════════════════════════════════════════════════════════════════╗")
        print(f"║                         NETWORK ASSESSMENT SUMMARY                       ║")
        print(f"╠════════════════════════════════════════════════════════════════════════════╣")
